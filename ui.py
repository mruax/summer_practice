...
################################################################################
## Form generated from reading UI file 'design_v2.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHeightForWidth(self.label_t0.sizePolicy().hasHeightForWidth())
        self.label_t0.setSizePolicy(sizePolicy)
        font1 = QFont()
        ...
        sizePolicy.setHeightForWidth(self.label_v0.sizePolicy().hasHeightForWidth())
        self.label_v0.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.label_x0.sizePolicy().hasHeightForWidth())
        self.label_x0.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.label_x0_2.sizePolicy().hasHeightForWidth())
        self.label_x0_2.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.label_omega0.sizePolicy().hasHeightForWidth())
        self.label_omega0.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.label_omega0_2.sizePolicy().hasHeightForWidth())
        self.label_omega0_2.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.label_a0.sizePolicy().hasHeightForWidth())
        self.label_a0.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.label_dt1.sizePolicy().hasHeightForWidth())
        self.label_dt1.setSizePolicy(sizePolicy)
